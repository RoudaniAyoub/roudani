...
<?php if(isset($jenna_redux_demo['cat_bg_light']['url']) && $jenna_redux_demo['cat_bg_light']['url'] != ''){?>
<section class="section bg-dark bg-theme" style="background-image: url('<?php echo esc_url($jenna_redux_demo['cat_bg_light']['url']); ?>');">
<?php }else{?>
<section class="section bg-dark bg-theme">
<?php }?>
	<div class="container">
		<div class="section-heading text-center">
			<?php if(isset($jenna_redux_demo['cat_title']) && $jenna_redux_demo['cat_title']){?>
				<h2><?php echo esc_attr($jenna_redux_demo['cat_title']);?></h2>
			<?php }else{?>
				<h2><?php echo esc_html__( 'Category', 'jenna' );?></h2>
			<?php } ?>
			<span class="cap"><?php printf( esc_html__( ' %s', 'jenna' ), single_cat_title( '', false ) );?></span>
		</div>
	</div>
</section>
