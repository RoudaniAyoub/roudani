...
final class BdevsElementor {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Jenna Elementor', 'bdevs-elementor' ) . '</strong>',
	...
	public function add_elementor_category() {
    	\Elementor\Plugin::instance()->elements_manager->add_category('bdevs-elementor',
	      	array(
					'title' => __( 'Jenna Elementor', 'bdevs-elementor' ),
					'icon'  => 'fa fa-plug',
	      	) 
	    );
	}
	...
	*/
	...
	public function init_widgets() { 
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/brand-section.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/project-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/services-section.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/experience-section.php';
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsProjectSection() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsServicesSection() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsExperianceSection() );
